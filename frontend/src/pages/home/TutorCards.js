...
function TutorCards({ tutor }) {
  return (
    ...
    >
      ...
      />
      <div className="flex flex-col p-3 gap-1 justify-center items-stretch">
        <h3 className="text-lg font-medium text-left">{tutor.name}</h3>
        <p className="text-xs text-gray-500">{tutor.experience} Experience</p>
