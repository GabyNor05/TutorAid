...
INSERT INTO `lessonreports` (`lessonReportID`, `studentID`, `subject`, `reportDate`, `comments`, `status`) VALUES
(1, 36, 'Math', '2025-09-29', 'He used inappropriate language and was very disrespectful.', 'Escalated');
...
(3, 6, 60, 'IT', '2025-09-28', '14:00:00', 60, 'declined'),
(5, 6, 40, 'Math', '2025-10-01', '16:00:00', 180, 'accepted'),
(6, 6, 40, 'IT', '2025-11-01', '16:00:00', 90, 'accepted'),
(7, 6, 40, 'Afrikaans', '2025-11-07', '16:00:00', 60, 'declined');
...
INSERT INTO `messages` (`messageID`, `senderID`, `receiverID`, `subject`, `body`, `isRead`, `sentAt`) VALUES
(1, 40, 60, 'Lesson Accepted', 'Your lesson request for Mathematics on 2025-10-15 at 16:00 has been accepted.', 0, '2025-10-12 23:47:52'),
(2, 40, 60, 'Lesson Declined', 'Unfortunately, your lesson request for IT on 2025-10-20 at 17:00 has been declined. Please choose another time.', 0, '2025-10-12 23:47:52'),
(4, 65, 60, 'Progress Note Published', 'Your progress note for Mathematics has been published. Please review your feedback in your dashboard.', 0, '2025-10-12 23:47:52'),
(5, 65, 60, 'Response to Your Query', 'Thank you for reaching out. Your question about lesson scheduling has been answered. Please check your dashboard for details.', 0, '2025-10-12 23:47:52');

-- --------------------------------------------------------

--
-- Table structure for table `newsubjectrequests`
--
...
(9, 40, 'https://res.cloudinary.com/dvkt6agj3/raw/upload/v1759685138/ltxgjuplvnf3vsfvpk67.pdf', 'lesson-feedback-2025-10-05-1.pdf', 'application/pdf', '2025-10-05 17:25:40', 4286),
(10, 40, 'https://res.cloudinary.com/dvkt6agj3/raw/upload/v1759685146/mo2yc2ow27vsejtcbewp.pdf', 'lesson-feedback-2025-10-05.pdf', 'application/pdf', '2025-10-05 17:25:47', 4315);
...
INSERT INTO `rating` (`ratingID`, `tutorID`, `studentID`, `rating`, `comment`, `created_at`) VALUES
(2, 6, 40, 5, 'She was a great tutor!', '2025-10-12 22:57:32');
...
INSERT INTO `studentrequests` (`studentRequestID`, `studentID`, `requestType`, `lessonDate`, `subjectID`, `newSubjectName`, `newSubjectDescription`, `query`, `createdAt`, `status`) VALUES
(6, 41, 'add_subject', NULL, NULL, 'isiNdebele', 'Very important for students whose mother tongue is isiNdebele, as they mostly take it as a First Additional Language at school. It is taught differently from isiNdebele Home Language, which can be hard for students.', NULL, '2025-09-30 01:42:36', 'Postponed'),
(7, 41, 'Progress_Note', '2025-10-05', 1, NULL, NULL, NULL, '2025-10-04 16:19:08', 'Rejected'),
(8, 40, 'Progress_Note', NULL, NULL, NULL, NULL, NULL, '2025-10-05 16:36:05', 'Pending'),
(9, 40, 'General_Query', NULL, NULL, NULL, NULL, NULL, '2025-10-05 16:44:18', 'Completed'),
(10, 40, 'New_Subject', NULL, NULL, NULL, NULL, NULL, '2025-10-05 16:45:38', 'Pending');
...
INSERT INTO `students` (`studentID`, `userID`, `grade`, `school`, `address`, `status`, `city`, `province`, `strikes`) VALUES
(36, 35, '12', 'Abbots College', 'The Moon', 'Inactive', 'Pretoria', 'Gauteng', 1),
(37, 36, '12', 'Affies', 'Fairway', 'Inactive', 'Johannesburg', 'Gauteng', 0),
(40, 60, '2', 'Glenstansia', 'Corner of Chopin and Duvenoux Str', 'Active', NULL, NULL, 0),
(41, 61, '12', 'Woodhill College', '123 Mac Bananas Str', 'Active', 'Pretoria', 'Gauteng', 0);
...
--
-- Indexes for table `newsubjectrequests`
--
ALTER TABLE `newsubjectrequests`
  ADD PRIMARY KEY (`newSubjectID`);
...
--
-- AUTO_INCREMENT for table `newsubjectrequests`
--
ALTER TABLE `newsubjectrequests`
  MODIFY `newSubjectID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `studentrequests`
  MODIFY `studentRequestID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`tutorID`) REFERENCES `tutors` (`tutorID`),
  ADD CONSTRAINT `rating_ibfk_2` FOREIGN KEY (`studentID`) REFERENCES `students` (`studentID`);
